...
class StrongSORT(object):
    def __init__(self, 
        ...
        metric2 = NearestNeighborDistanceMetric(
            "cosine", self.max_dist, nn_budget)
        
        self.tracker = Tracker(
            metric, metric2, max_iou_distance=max_iou_distance, max_age=max_age, n_init=n_init)

    def update(self, bbox_xywh, confidences, classes, ori_img, recFeature=None):
        ...
        self.tracker.update(detections, classes, confidences, recFeature)
