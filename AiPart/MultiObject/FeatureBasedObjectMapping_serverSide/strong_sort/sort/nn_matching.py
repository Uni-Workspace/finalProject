...
class NearestNeighborDistanceMetric(object):
    ...
    def __init__(self, metric, matching_threshold, budget=None):
        if metric == "euclidean":
            ...
            self._metric2 = _nn_cosine_distance2
        else:
            raise ValueError(
    ...
    def distance2(self, features, targets):
        ...
        for i, target in enumerate(targets):
            ...
            # print(features)
            # print("====================================================================================")
            # print(type(self.samples[1]))
            # print(self.samples[1].keys())
            # print(self.samples[1])
            # print("====================================================================================")
            # print(self.samples.values())
            cost_matrix[i, :] = self._metric2(self.samples[target], features)
            print("HERE")
