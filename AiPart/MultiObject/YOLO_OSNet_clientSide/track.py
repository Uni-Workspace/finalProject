...
def run(
    ...
    # with open('E:/temp2/weights/obj.pickle', "wb") as file:
    #     pickle.dump(strongsort_list[0], file)
    #     print("PICKLED")
    ...
    for frame_idx, (path, im, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if cfg.STRONGSORT.ECC:  # camera motion compensation
                ...
                print("================================")
                print("Track Counts: ")
                print(len(strongsort_list[i].tracker.tracks))
                print("================================")
                print("================================")
            ...
            if det is not None and len(det):
                ...
                t4 = time_sync()
                if click_X is not None and click_Y is not None and Selection is not False:
                    outputs[i] = strongsort_list[i].update(xywhs.cpu(), confs.cpu(), clss.cpu(), im0, click_X, click_Y, Selection)
                else:
            ...
            if show_vid:
                ...
                tracks = strongsort_list[0].tracker.tracks
                for track in tracks:
