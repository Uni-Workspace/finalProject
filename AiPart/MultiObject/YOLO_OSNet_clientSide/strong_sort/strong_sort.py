...
class StrongSORT(object):
    ...
    def update(self, bbox_xywh, confidences, classes, ori_img, click_X=None, click_Y=None, Selection=False):
        ...
        if click_X is not None and click_Y is not None and Selection is not False:
            self.tracker.update(detections, classes, confidences, click_X, click_Y, Selection)
        else:
